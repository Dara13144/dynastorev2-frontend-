    ...
    <div className="py-12 max-w-md mx-auto">
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Join DynaStore to buy and download digital game files</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-xs font-semibold text-slate-300 block mb-1.5">Gamer Username</label>
            <div className="relative">
              <input
                type="text"
                value={username}
